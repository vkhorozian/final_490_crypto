...
<div class="container">
    ...
    <form  method="post" action = "buy.php">
        <div class="form-group">
            <div class="cols-lg-6">
                <input class=form-control type=text name="sell_amount" id="sell_amount" required="required" hidden="<?php $_SESSION['action'] = 'sell'; ?>" placeholder="Sell Amount">
            </div>
    ...
    <form  method="post" action = "buy.php">
        <div class="form-group">
            <div class="cols-lg-6">
                <input class=form-control type=text name="buy_amount" id="buy_amount" required="required" hidden="<?php $_SESSION['action'] = 'buy';   ?>" placeholder="Buy Amount" >
            </div>
